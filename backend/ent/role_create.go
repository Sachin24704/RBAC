...
func (rc *RoleCreate) AddRoleOperationIDs(ids ...int) *RoleCreate {
	rc.mutation.AddRoleOperationIDs(ids...)
	return rc
}

// AddRoleOperations adds the "role_operations" edges to the RoleOperation entity.
func (rc *RoleCreate) AddRoleOperations(r ...*RoleOperation) *RoleCreate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return rc.AddRoleOperationIDs(ids...)
}
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if nodes := rc.mutation.RoleOperationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
