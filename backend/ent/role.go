...
// was not loaded in eager-loading.
func (e RoleEdges) RoleOperationsOrErr() ([]*RoleOperation, error) {
	if e.loadedTypes[1] {
...
// QueryRoleOperations queries the "role_operations" edge of the Role entity.
func (r *Role) QueryRoleOperations() *RoleOperationQuery {
	return NewRoleClient(r.config).QueryRoleOperations(r)
}
