...
func (ru *RoleUpdate) AddRoleOperationIDs(ids ...int) *RoleUpdate {
	ru.mutation.AddRoleOperationIDs(ids...)
	return ru
}

// AddRoleOperations adds the "role_operations" edges to the RoleOperation entity.
func (ru *RoleUpdate) AddRoleOperations(r ...*RoleOperation) *RoleUpdate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return ru.AddRoleOperationIDs(ids...)
}
...
func (ru *RoleUpdate) ClearRoleOperations() *RoleUpdate {
	ru.mutation.ClearRoleOperations()
	return ru
}

// RemoveRoleOperationIDs removes the "role_operations" edge to RoleOperation entities by IDs.
func (ru *RoleUpdate) RemoveRoleOperationIDs(ids ...int) *RoleUpdate {
	ru.mutation.RemoveRoleOperationIDs(ids...)
	return ru
}

// RemoveRoleOperations removes "role_operations" edges to RoleOperation entities.
func (ru *RoleUpdate) RemoveRoleOperations(r ...*RoleOperation) *RoleUpdate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return ru.RemoveRoleOperationIDs(ids...)
}
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if ru.mutation.RoleOperationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.RoleOperationsTable,
			Columns: []string{role.RoleOperationsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := ru.mutation.RemovedRoleOperationsIDs(); len(nodes) > 0 && !ru.mutation.RoleOperationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.RoleOperationsTable,
	...
	if nodes := ru.mutation.RoleOperationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.RoleOperationsTable,
...
// AddRoleOperationIDs adds the "role_operations" edge to the RoleOperation entity by IDs.
func (ruo *RoleUpdateOne) AddRoleOperationIDs(ids ...int) *RoleUpdateOne {
	ruo.mutation.AddRoleOperationIDs(ids...)
	return ruo
}

// AddRoleOperations adds the "role_operations" edges to the RoleOperation entity.
func (ruo *RoleUpdateOne) AddRoleOperations(r ...*RoleOperation) *RoleUpdateOne {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return ruo.AddRoleOperationIDs(ids...)
}
...
// ClearRoleOperations clears all "role_operations" edges to the RoleOperation entity.
func (ruo *RoleUpdateOne) ClearRoleOperations() *RoleUpdateOne {
	ruo.mutation.ClearRoleOperations()
	return ruo
}

// RemoveRoleOperationIDs removes the "role_operations" edge to RoleOperation entities by IDs.
func (ruo *RoleUpdateOne) RemoveRoleOperationIDs(ids ...int) *RoleUpdateOne {
	ruo.mutation.RemoveRoleOperationIDs(ids...)
	return ruo
}

// RemoveRoleOperations removes "role_operations" edges to RoleOperation entities.
func (ruo *RoleUpdateOne) RemoveRoleOperations(r ...*RoleOperation) *RoleUpdateOne {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return ruo.RemoveRoleOperationIDs(ids...)
}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if ruo.mutation.RoleOperationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.RoleOperationsTable,
	...
	if nodes := ruo.mutation.RemovedRoleOperationsIDs(); len(nodes) > 0 && !ruo.mutation.RoleOperationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.RoleOperationsTable,
	...
	if nodes := ruo.mutation.RoleOperationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   role.RoleOperationsTable,
